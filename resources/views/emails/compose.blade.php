                              ...
                              <tbody>
                                 <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                       <div class="imgpop">
                                          <a href="#"><img src="{{ asset('/img/logo.png') }}" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
                                       </div>
                                    </td>
                                 </tr>
                              </tbody>
                           ...
                           <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                              <tbody>
                                 <tr>
                                    <!-- start of image -->
                                    <td align="center">
                                       <a target="_blank" href="#"><img width="540" border="0" height="282" alt="" style="display:block; border:none; outline:none; text-decoration:none;" src="{{ asset('/imgemil/bigimage.png') }}" class="bigimage"></a>
                                    </td>
                                 </tr>
                                 <!-- end of image -->
                                 <!-- Spacing -->
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                <td width="200" height="180" align="center">
                                                   <img src="{{ asset('/img/left-image.png') }}" alt="" border="0" width="180" height="180" style="display:block; border:none; outline:none; text-decoration:none;">
                                                </td>
                                             </tr>
                                          </tbody>
                                       </table>
                                    ...
                                    <td>
                                       ...
                                       <table width="200" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                          <tbody>
                                             ...
                                             <tr>
                                                <td width="200" height="180" align="center">
                                                   <img src="{{ asset('/img/right-image.png') }}" alt="" border="0" width="180" height="180" style="display:block; border:none; outline:none; text-decoration:none;">
                                                </td>
                                             </tr>
                                          </tbody>
                                       </table>
                                    ...
                                    <td>
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                <td width="260" height="140" align="center" class="devicewidth">
                                                   <img src="{{ asset('/img/2col-image1.png') }}" alt="" border="0" width="260" height="140" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                </td>
                                             </tr>
                                             <!-- Spacing -->
                                             <tr>
                                       ...
                                       <table width="260" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                          <tbody>
                                             ...
                                             <tr>
                                                <td width="260" height="140" align="center" class="devicewidth">
                                                   <img src="{{ asset('/img/2col-image2.png') }}" alt="" border="0" width="260" height="140" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                                </td>
                                             </tr>
                                             <!-- Spacing -->
                                             <tr>
                                    ...
                                    <td>
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                <td width="170" height="128" align="center" class="devicewidth">
                                                   <img src="{{ asset('/img/3col-image.png') }}" alt="" border="0" width="170" height="128" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                </td>
                                             </tr>
                                             <!-- end of image2 -->
                                             <tr>
                                       ...
                                       <table width="170" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                          <tbody>
                                             ...
                                             <tr>
                                                <td width="170" height="128" align="center" class="devicewidth">
                                                   <img src="{{ asset('/img/3col-image.png') }}" alt="" width="170" height="128" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="col3img">
                                                </td>
                                             </tr>
                                             <!-- end of image3 -->
                                             <tr>
